...
public class ConstantesFacturacion {
	...
	public static final String ID_GESTIONFACTURACION = "MENU_BlotterFacturacion";
	public static final String ID_MODULOGESTIONFACTURACION = "MENU_MODULO_FACTURACION";
	...
	public static final String XPATH_COMPARARFOLIO = "//*[@id='grid-movimientos-facturar']/span/div[2]/div[4]/table//span[@ng-bind='dataItem.FolioTransaccion' and contains(text(),"+Session.getFolio()+")]";
	public static final String XPATH_COMPARARMONTO = "//*[@id='grid-movimientos-facturar']/span/div[2]/div[4]/table//span[@ng-bind='dataItem.Monto' and contains(text(),"+monto+")]";
	...
	public static final String XPATHERE = "//*[@id='grid-movimientos-facturar']/span/div[2]/div[4]/table//span[@ng-bind='dataItem.FolioTransaccion' and contains(text(),"+Session.getFolio()+")]";
