...
public class MantenedorUtil {
	 ...
	 * @return
	 */
	protected static boolean findEUR( Session session) {
		boolean result = false;
		try {
			WebElement input = UtilesSelenium.findElement(session.getConfigDriver(), By.xpath(ConstantesMantenedorPuntas.XPATH_SELECCIONAR_MONEDA));
			input.clear();
